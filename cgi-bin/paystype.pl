...
%ct=(
 ...
 96 => 'Платежный терминал PayOk',
 97 => 'Платежный терминал ОСМП',
 98 => 'Эквайринг',
...
%ct_decode_mess=(
  97 => 'Закодирован идентификатор платежа в системе ОСМП. По этому идентификатору производится дальнейшая сверка взаиморасчетов и решение спорных вопросов. Изменять не рекомендуется.',
  98 => 'Закодирован идентификатор платежа в системе PayOk. По этому идентификатору производится дальнейшая сверка взаиморасчетов и решение спорных вопросов. Изменять не рекомендуется.',
...
%category_subs=(
   ...
   96 => \&ct_payterm_payok,		# Платежный терминал PayOk
   97 => \&ct_payterm_osmp,		# Платежный терминал ОСМП
...
sub ct_payterm_osmp
{
 return("Уникальный id платежа в системе ОСМП: ".&Filtr_out($_[0]));
}

sub ct_payterm_payok
{
 return("Уникальный id платежа в система PayOk: ".&Filtr_out($_[0]));
}
